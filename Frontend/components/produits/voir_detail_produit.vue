  ...
  <div>
    ...
    <UModal v-model="isOpen">
      ...
      <div class="p-4">
        ...
        <h4 v-if="isSuperAdmin && product.prix_achat" class="text-green-600 font-bold">Prix d'achat: {{
          product.prix_achat }} XAF</h4>
        ...
        <h4 class="mt-2">Statut : <span :class="product.actif ? 'text-green-600' : 'text-red-600'">{{ product.actif ?
          'Actif' :
            'Inactif' }}</span></h4>
      </div>
    </UModal>
