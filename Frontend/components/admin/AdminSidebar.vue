...
<!-- <template>
    <div
      class="hidden z-10 md:block fixed w-[200px]  py-5 px-2 border-r dark:border-r-gray-600 border-r-gray-200 overflow-y-auto"
    >
      <div class="flex items-center justify-center">
        <NuxtLink href="/" class="text-lg md:text-xl font-extrabold pb-3"
